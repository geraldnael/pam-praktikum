...
import com.ifs21015.lostfound.data.local.entity.DelcomLostFoundEntity
import com.ifs21015.lostfound.data.remote.MyResult
import com.ifs21015.lostfound.databinding.ActivityLostFoundFavoriteBinding
import com.ifs21015.lostfound.helper.Utils.Companion.entitiesToResponses
                ...
                object : LostFoundsAdapter.OnItemClickCallback {
                    override fun onCheckedChangeListener(
                        ...
                        val newLostFound = DelcomLostFoundEntity(
                            ...
                            isCompleted = todo.isCompleted, // Sesuaikan dengan isCompleted
                            cover = todo.cover,
                            ...
                            when (it) {
                                ...
                                is MyResult.Success -> {
                                    if (isChecked) {
                                        Toast.makeText(
                                            this@LostFoundFavoriteActivity,
                                            "Berhasil menyelesaikan LostFound: " + todo.title,
                                            Toast.LENGTH_SHORT
                                        ).show()
                                    } else {
                                        Toast.makeText(
                                            this@LostFoundFavoriteActivity,
                                            "Berhasil batal menyelesaikan lostfound: " + todo.title,
                                            Toast.LENGTH_SHORT
                                        ).show()
                                    }
