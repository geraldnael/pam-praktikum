...
import com.ifs21015.lostfound.data.model.LostFound
import com.ifs21015.lostfound.data.remote.MyResult
import com.ifs21015.lostfound.data.remote.response.LostFoundResponse
import com.ifs21015.lostfound.databinding.ActivityLostfoundDetailBinding
    ...
    private fun observeGetLostFound(todoId: Int) {
        viewModel.getLostFound(todoId).observeOnce { result ->
            when (result) {
                ...
                is MyResult.Success -> {
                    showLoading(false)
                    loadLostFound(result.data.data.todo)
                }
